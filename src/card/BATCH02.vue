<template>
  <v-card-title>
    <div><label style="color: blue">ຂໍ້ມູນລາຍລະອຽດໃນເຊີບເວີ BATCH02 >> </label> <br /></div>
    <v-alert
      >{{ this.getdata }} <br />
      {{ this.getdata1 }} <br />
    ...
    Search_info() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.getdata1 = response.data.substring(1664, 1729);
       
          this.getdata10 = response.data.substring(1713, 1715);
