<template>
  <v-card-title>
    <div>
      <label style="color: blue">ຂໍ້ມູນລາຍລະອຽດໃນເຊີບເວີ Aq Switch >></label>
      <br />
    </div>
    <v-alert
      >{{ this.getdata }} <br />
    ...
    Search_info() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.getdata3 = response.data.substring(159, 215);
          ...
          // this.getdata9 = response.data.substring(502, 595);
