  ...
  <v-card class="CustomerList" style="font-family: phetsarath OT">
    ...
    >
      ...
      <template  v-if="isAuthorized">
        <v-row class="text-center"  v-if="isAuthorized">
      <v-col class="text-center">Total Amount: ${{ TotalAmount }}</v-col>
    </v-row>
      </template>
...
export default {
  ...
  data() {
    return {
      ...
      options: {},
      headers: [
        { text: "AUTHORIZATIONDATE:", value: "AUTHORIZATIONDATE" },
        { text: "CUSTOMER_ID:", value: "CUSTOMER_ID" },
        { text: "ACCOUNT_NO:", value: "ACCOUNT_NO" },
        { text: "CARD_NO:", value: "CARD_NO" },
        { text: "TXN_CURRENCY:", value: "TXN_CURRENCY" },
        { text: "TOTAL_AMOUNT_DUE:", value: "TOTAL_AMOUNT_DUE" },
        { text: "TXN_AMOUNT:", value: "TXN_AMOUNT" },
        { text: "USD_AMOUNT:", value: "USD_AMOUNT" },
        { text: "ARREARS_AMOUNT:", value: "ARREARS_AMOUNT" },
        ...
        { text: "TRANSACTIONDESCRIPTION:", value: "TRANSACTIONDESCRIPTION" },
        { text: "MERCHANTCOUNTRY:", value: "MERCHANTCOUNTRY" },
        { text: "MERCHANTCITY:", value: "MERCHANTCITY" },
        { text: "MERCHANTID:", value: "MERCHANTID" },
        { text: "MERCHANTNAME:", value: "MERCHANTNAME" },
        { text: "TERMINALID:", value: "TERMINALID" },
        { text: "TERMINALADDRESS:", value: "TERMINALADDRESS" },
      ],
      getdata: [],
      getdataACC: [],
      valid: false,
  ...
  methods: {
    ...
    searchinfo() {
      this.formattedDate_from = moment(this.from_date).format("YYYY-MM-DD");
      this.formattedDate_to = moment(this.to_date).format("YYYY-MM-DD");
      // alert(this.formattedDate_from + "_to_date" + this.formattedDate_to);
      ...
      if (this.from_date !== "" && this.to_date !== "") {
        if (this.ACC != "" && this.ACC !=null) {
          ...
          axios
            .post("http://10.0.22.236:9889/api/post/post_getvisacredit_byaccount", {
              from_date: this.formattedDate_from,
              to_date: this.formattedDate_to,
              ACC: this.ACC,
              headers: {
            ...
            .then((response) => {
              if (response.data.status == "success") {
                ...
                if (response.data.data.length - 1 == -1) {
                  ...
                  this.getdataACC = response.data.data;
                  if(this.getdataACC !=""){
          ...
          this.loading_icon = true;
          axios
            .post("http://10.0.22.236:9889/api/post/post_getvisacredit", {
              from_date: this.formattedDate_from,
              to_date: this.formattedDate_to,
